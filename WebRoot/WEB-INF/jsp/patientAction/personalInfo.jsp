...
<script type="text/javascript">
	$(function() {
		$("#patientInfo").addClass('li_checked');
	});
</script>
<title>我的账户</title>
</head>
				...
				<div class="rightSide">
					...
					<div class="infoContent">
							...
							<div class="fieldArea">
								...
								手机<br /> 微信<br /> 等级<br /> 在线时间<br /> 注册时间<br />
							</div>
							<s:form id="basicInfoForm" action="patient_updateBasicInfo" method="post">
							<div class="fieldPropertyArea">
								...
								<s:textfield id="birthday" type="text" name="birthday" value="%{#brd}" cssClass="inputStyle"/>
								<br /> 
