	...
	<div class="bodyPage">
		...
		<div class="mainPage">
			...
			<div class="rightSideTemplate">
				<div class="rightSide">
					<div class="centerTitle">训练计划 &gt; 今日计划</div>
					<!-- 今日计划 -->
					...
					<div class="todayPlan">
						<table width="95%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<th width="20%" scope="col">训练设备</th>
								<!-- 这里其实还应该包括训练次数 -->
								<th width="15%" scope="col">训练时间</th>
								<th width="15%" scope="col">训练医师</th>
								<th width="15%" scope="col">主治医师</th>
							</tr>
							<!-- 这里循环 -->
							<s:iterator value="%{#todayRehabPlansList}">
