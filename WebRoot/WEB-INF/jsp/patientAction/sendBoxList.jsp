				...
				<div class="rightSide">
					...
					<div class="messages">	
						...
						<s:iterator value="%{recordList}">
							<s:a action="patient_sendMessageShowUI?message.id=%{id}"><li style="display:block;width:650px; height:30px; border-bottom:1px #DDD dashed;">
						...
						<div class="patientBtnStyle">
								<s:a action="patient_sendMessageUI.action">现在写信</s:a>
						</div>
						<!-- 分页信息 -->
