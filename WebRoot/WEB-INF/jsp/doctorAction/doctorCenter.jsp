						...
						<div class="userInfo">
							您好！ ${user.trueName}<br /> 今日计划<span style="color:#C30;"
								id="todayRehabPlanCount"><s:a
									action="doctor_todayRehabPlanUI">【 ${todayRehabPlanCount} 】</s:a></span><br />
							<s:if test="%{#session.user.lastLoginTime != null}">     
            上次登陆时间: <span style="font-size:16px; color:#000;"> <s:date
										name="%{#session.user.lastLoginTime}"
            	...
            	这是您的第一次登录
					...
					<div class="instruction">
						...
						<p style="color:#F00;">*4. 患者就诊时，如患者已注册MRE网站，您可以授权关联其为自己的患者</p>
						<p>5. 完成第四条后，可以管理您的患者，为其制定康复计划，查看其康复评定的效果等信息</p>
						<p />
						<p />	
						<p />
