				...
				<div class="rightSide">
					<div class="centerTitle">站内信息 &gt; 发件箱</div>
						...
						<s:iterator value="%{#recordList}">
							<s:a action="therapist_sendMessageShowUI?message.id=%{id}"><li style="display:block;width:650px; height:30px; border-bottom:1px #DDD dashed;">
						...
						<div class="doctorBtnStyle">
								<s:a action="therapist_sendMessageUI.action">现在写信</s:a>
						</div>
						<!-- 分页信息 -->
