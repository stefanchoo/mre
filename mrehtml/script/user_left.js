...
$(function(){
		$(".foldBtn1, .foldBtn2, .foldBtn3, .foldBtn4, .foldBtn5, .foldBtn6").mouseleave(function(){
			$(this).css('background-image','url(../style/images/button/arrow_carrot-down.png)');
			});
			
		$(".foldBtn1, .foldBtn2, .foldBtn3, .foldBtn4, .foldBtn5, .foldBtn6").mousemove(function(){
			$(this).css('background-image','url(../style/images/button/arrow_carrot-on.png)');
			});
		...
		$("li > ul > li:not(.li_checked)").mouseleave(function(){
			$(this).removeClass('li_on');
			});
			
		$("li > ul > li:not(.li_checked)").mousemove(function(){
			$(this).addClass('li_on');
		});	
